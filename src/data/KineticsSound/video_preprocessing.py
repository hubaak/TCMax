...
class Video_dataset(object):
    def __init__(self, path_to_dataset = Dataset_Config().get_dataset_root("Kinetics-Sounds"), frame_interval=1, frame_kept_per_second=1):
    ...
    def extractImage(self):
        ...
        for each_video in pbar:
            pbar.set_description_str('Precessing {} ...'.format(each_video))
